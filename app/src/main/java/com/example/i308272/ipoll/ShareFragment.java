    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bt.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Install App";
                String shareSubject = "Your Share Subject";
                shareIntend.putExtra(Intent.EXTRA_SUBJECT, shareSubject);
                shareIntend.putExtra(Intent.EXTRA_TEXT, shareBody);
                startActivity(Intent.createChooser(shareIntend, "ShareUsing"));
            }
        });
